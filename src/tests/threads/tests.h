...
extern test_func test_to_decimal;
extern test_func test_to_int_rounding_zero;
extern test_func test_to_int_rounding_nearest;
extern test_func test_multiple_operations;
